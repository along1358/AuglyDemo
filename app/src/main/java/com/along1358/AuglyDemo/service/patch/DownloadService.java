...
import com.along1358.AuglyDemo.service.retrofit.adapter.rxjava3.RxJava3CallAdapterFactory;
...
public class DownloadService {
    ...
    public void download(CheckInfoResponseBody info, String path, DownloadListener listener) {
            ...
            public void progress(long read, long contentLength, boolean done) {
                ...
                Observable.just(1).observeOn(AndroidSchedulers.mainThread()).subscribe(new Observer<Integer>() {
                    ...
                    public void onNext(Integer value) {
                        if (listener != null) {
                            if (!done) {
                                ...
                                progress = -1;
                                listener.onFinish(info, downloadInfo.savePath);
                            }
                        }
                    }
                    ...
                    public void onError(Throwable e) {
                        if (listener != null)
                            listener.onError(info, e.getMessage());
                    }
        ...
        if (listener != null)
            listener.onStarted(info, downloadInfo.savePath);
    }
