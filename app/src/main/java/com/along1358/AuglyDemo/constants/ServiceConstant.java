...
public class ServiceConstant {
    ...
    public static final String RES_URL_UPDATE_INFO_JSON = "update/" + APP_NAME + "/update.json";
    public static final String RES_URL_PATCH_INFO_JSON = "patch/" + APP_NAME + "/" + BuildConfig.VERSION_NAME + "/patch.json";
}
